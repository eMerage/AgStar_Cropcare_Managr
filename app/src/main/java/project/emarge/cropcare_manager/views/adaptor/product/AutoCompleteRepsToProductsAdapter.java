package project.emarge.cropcare_manager.views.adaptor.product;
...
public class AutoCompleteRepsToProductsAdapter extends ArrayAdapter<Rep> {

    Context context;
    int resource, textViewResourceId;
    List<Rep> items, tempItems, suggestions;

    public AutoCompleteRepsToProductsAdapter(Context context, int resource, int textViewResourceId, List<Rep> items) {
